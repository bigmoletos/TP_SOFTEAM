...
//on va maintenant remplir par le nombre de dossier en bouclant sur chaque dossier pour recuperer son indice
//ici de 0 à 3
...
foreach($dossiers as $indice_dossier=>$nomdossier) {
    ...
    echo'nom du dossier'.$nomdossier;
}

//on assigne 0 à toutes les valeurs du tableau $_SESSION avec le =false
