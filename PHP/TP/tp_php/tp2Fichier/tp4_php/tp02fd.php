...
// variable de session : 
//si le tableau $_SESSION n'existe pas on le crée
...
if (($indice_dossier >= 0) && ($indice_dossier < $nbDossiers))
{
	...
	// ajout du lien vers la page principale, ici ou ailleurs...
	$nav_dossier = "<div class=''><a href='listearticle.php'>retour à la liste des nouvelles</a></div>".$nav_dossier;
	...
	if (($indice >= 0) && ($indice < $nbFichiers)) 
		{
		//le ficher est lu, il faut le marquer comme tel 
