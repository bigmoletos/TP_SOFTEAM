...
//traitement html
if (empty($select)) {
	$affichagePage =  "<input type=submit name=\"change\" value=\"CHANGE\">";
}else{
	$affichagePage = $select .  "<select name=\"attribut\"><option value=\"prenom\">Prénom</option><option value=\"age\">Âge</option></select>" . "<input type=\"text\" name=\"saisie\" required><br />" . "<input type=submit name=\"modifier\" value=\"MODIFIER\">" . "<input type=submit name=\"supprime\" value=\"SUPPRIME\" >";
}
